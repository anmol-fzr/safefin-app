...
import { ProfileScreen, DemoDebugScreen, QuizzesScreen, CalculatorListScreen } from "../screens"
  ...
  return (
    ...
    >
      ...
      <Tab.Screen
        ...
        options={{
          tabBarAccessibilityLabel: translate("demoNavigator:calculatorListTab"),
