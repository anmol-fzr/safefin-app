...
type UseYupFormProps<TFieldValues extends FieldValues, TSchema extends ObjectSchema<TFieldValues>, TContext = any> = Omit<
  UseFormProps<InferType<TSchema>, TContext>,
  "resolver"
> & {
  schema: TSchema;
...
export function useYupForm<
  ...
  TContext = any
>({ schema, resolverOptions, ...props }: UseYupFormProps<TFieldValues, TSchema, TContext>) {
